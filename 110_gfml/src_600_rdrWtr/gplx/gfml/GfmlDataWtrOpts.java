...
public class GfmlDataWtrOpts {
	...
	public static GfmlDataWtrOpts cast_(Object obj) {try {return (GfmlDataWtrOpts)obj;} catch(Exception exc) {throw Err_.type_mismatch_exc_(exc, GfmlDataWtrOpts.class, obj);}}
}
