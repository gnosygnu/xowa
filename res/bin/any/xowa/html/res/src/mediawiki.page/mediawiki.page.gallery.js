...
*/
function gallery_packed_exec( $, mw ) {
	$( function () {
		var isTouchScreen,
			gettingFocus,
...
//              dbg(1, wantedWidth, combinedPadding, curRow[j].width, curRow[j].imgWidth);
						}
					}
...
// TOMBSTONE: do not auto-call packed; calling twice causes problems with packed.js; DATE:2016-08-14
