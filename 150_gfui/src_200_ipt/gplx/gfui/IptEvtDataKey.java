...
public class IptEvtDataKey {
	...
	public static IptEvtDataKey cast_(Object obj) {try {return (IptEvtDataKey)obj;} catch(Exception exc) {throw Err_.type_mismatch_exc_(exc, IptEvtDataKey.class, obj);}}
