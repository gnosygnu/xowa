...
public class IptEvtDataMouse {
	...
	public static IptEvtDataMouse cast_(Object obj) {try {return (IptEvtDataMouse)obj;} catch(Exception exc) {throw Err_.type_mismatch_exc_(exc, IptEvtDataMouse.class, obj);}}
