...
public class GfuiAlign_ implements ParseAble {
	...
	public static GfuiAlign cast_(Object obj) {try {return (GfuiAlign)obj;} catch(Exception exc) {throw Err_.type_mismatch_exc_(exc, GfuiAlign.class, obj);}}
	...
	public static int CalcInsideOfAxis(int posEnm, int innerSize, int outerSize) {
		...
		else										throw Err_.unhandled(posEnm);
		if (rv < 0) rv = 0;
		return rv;
	}
}
