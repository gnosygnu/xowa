...
public class Swing_kit extends Gfui_kit_base {
	private BryFmtr ask_fmtr = BryFmtr.New(); private BryWtr ask_bfr = BryWtr.New();
	...
	@Override public void Ask_ok(String grp_key, String msg_key, String fmt, Object... args) {GfuiEnv_.ShowMsg(ask_fmtr.BldToStrMany(ask_bfr, fmt, args));}
