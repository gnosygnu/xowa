...
public class FontStyleAdp_ implements ParseAble {
	...
	public static FontStyleAdp cast_(Object obj) {try {return (FontStyleAdp)obj;} catch(Exception exc) {throw Err_.type_mismatch_exc_(exc, FontStyleAdp.class, obj);}}
	...
	public static FontStyleAdp parse_(String raw) {
		FontStyleAdp rv = parse_internal_(raw); if (rv == null) throw Err_.unhandled(raw);
		return rv;
	}
