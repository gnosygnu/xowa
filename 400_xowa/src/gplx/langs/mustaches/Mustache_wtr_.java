...
public class Mustache_wtr_ {
	public static byte[] Write_to_bry(byte[] src, Mustache_doc_itm itm) {return Write_to_bry(BryWtr.New(), src, itm);}
	public static byte[] Write_to_bry(BryWtr bfr, byte[] src, Mustache_doc_itm itm) {
