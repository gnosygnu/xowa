...
public class Json_printer_tst {
	...
	@Test public void Root_nde() {
		fxt.Test_print(Json_doc.Make_str_by_apos("{'k1':'v1','k2':'v2'}"), StringUtl.ConcatLinesNl
		( "{ 'k1':'v1'"
		, ", 'k2':'v2'"
		, "}"
		));
	...
	@Test public void Root_ary() {
		fxt.Test_print(Json_doc.Make_str_by_apos("[1,2,3]"), StringUtl.ConcatLinesNl
		( "[ 1"
		, ", 2"
		, ", 3"
		, "]"
	...
	@Test public void Ary_w_ary() {
		fxt.Test_print(Json_doc.Make_str_by_apos("[[1,2],[3,4]]"), StringUtl.ConcatLinesNl
		( "[ "
		, "  [ 1"
		, "  , 2"
		, "  ]"
	...
	@Test public void Ary_w_nde() {
		fxt.Test_print(Json_doc.Make_str_by_apos("[{'k1':'v1','k2':'v2'},{'k3':'v3','k4':'v4'}]"), StringUtl.ConcatLinesNl
		( "[ "
		, "  { 'k1':'v1'"
		, "  , 'k2':'v2'"
		, "  }"
	...
	@Test public void Nde_w_ary() {
		fxt.Test_print(Json_doc.Make_str_by_apos("{'k1':[1,2],'k2':[3,4]}"), StringUtl.ConcatLinesNl
		( "{ 'k1':"
		, "  [ 1"
		, "  , 2"
		, "  ]"
...
class Json_printer_fxt {
	...
	public void Test_print(String raw, String expd) {
		GfoTstr.EqLines(expd, printer.Print_by_bry(BryUtl.NewU8(raw)).To_str());
	}
}
