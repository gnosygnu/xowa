...
public class Php_srl_parser_tst {
	...
	@Test public void Num_double_inf_pos(){fxt.Test_parse("d:INF;", fxt.itm_double_(DoubleUtl.InfinityPos));}
	@Test public void Num_double_exp()	{fxt.Test_parse("d:1.2e+2;", fxt.itm_double_(120));}
	@Test public void Num_double_nan()	{fxt.Test_parse("d:NAN;", fxt.itm_double_(DoubleUtl.NaN));}
	...
	@Test public void Ary_flat_many()		{
		fxt.Test_parse(StringUtl.Concat
		(	"a:3:{"
		,	"i:1;i:9;"
		,	"i:2;i:8;"
		,	"i:3;i:7;"
...
class Php_srl_parser_fxt {
	...
	}	Php_srl_parser parser; Php_srl_factory factory; BryWtr tmp_bfr = BryWtr.NewAndReset(255);
