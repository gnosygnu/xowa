...
public class Xoa_cfg_db_txt implements Xoa_cfg_db {
	...
	public Io_url Cfg_url(Xoa_cfg_mgr cfg_mgr) {return cfg_mgr.App().User().Fsys_mgr().App_data_cfg_dir().GenSubFil(File_name);}	
