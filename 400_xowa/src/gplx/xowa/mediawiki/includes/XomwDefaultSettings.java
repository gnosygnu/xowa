...
//
//		/**
//		* To enable remote on-demand scaling, set this to the thumbnail super URL.
...
//
//		/**
//		* Map of relative URL directories to match to @gplx.Internal protected mwstore:// super storage paths.
...
//		*                          url        : super URL to the root of the zone
//		*                          urlsByExt  : map of file extension types to super URLs
...
//		*                      some remote repos.
//		*   - thumbDir         The super thumbnail directory. Defaults to "<directory>/thumb".
//		*   - thumbUrl         The super thumbnail URL. Defaults to "<url>/thumb".
...
//		*  - 'lockManager'  : The name of a synchronized manager (see $wgLockManagers)
//		*
...
//
//		/**
//		* Array of configuration arrays for each synchronized manager.
//		* Each backend configuration has the following parameters:
//		*  - 'name'        : A unique name for the synchronized manager
//		*  - 'class'       : The synchronized manger class to use
//		*
//		* See LockManager::__construct() for more details.
//		* Additional parameters are specific to the synchronized manager class used.
...
//
//		/**
//		* Resizing can be done using PHP's @gplx.Internal protected image libraries or using
...
//		*                  - DBO_COMPRESS -- uses @gplx.Internal protected compression in database connections,
//		*                                    if available
//		*
...
//
//		/**
//		* Number of @gplx.Internal protected PBKDF2 iterations to use when deriving session secrets.
//		*
//		* @since 1.28
//		*/
...
//		*
//		* WARNING: Do not add 'file:' to this or @gplx.Internal protected file links will be broken.
...
//		* Only works for @gplx.Internal protected tidy.
//		*/
//		$wgDebugTidy = false;
//
//		/**
...
//		* @var boolean[] operation => boolean. A 'default' key must always be provided.
//		*/
...
//		* that a synchronized file be defined and creatable/removable by the web
//		* server.
//		*/
...
//			// of somebody using this as a DoS attack to synchronized someone
...
//
//		/**
//		* @var boolean Whether to enable bot passwords
//		* @since 1.27
//		*/
...
//		* @var String|boolean If false, the normal cluster will be used
//		* @since 1.27
//		*/
...
//		* "{$database}-{$prefix}".
//		* @var String|boolean If false, the normal database will be used
//		* @since 1.27
//		*/
...
//
//		/**
//		* Disable the @gplx.Internal protected MySQL-based search, to allow it to be
...
//
//		/**
//		* If this synchronized file exists (size > 0), the wiki will be forced into read-only mode.
...
//		*
//		* Note that affected jobs may have worse synchronized contention. Also, if they affect
...
//		* also fail due to the commit synchronized acquisition timeout.
//		*
//		* @var float|boolean
//		* @since 1.26
//		*/
...
//		*
//		* @var int|boolean Disabled if false
//		* @since 1.27
//		*/
