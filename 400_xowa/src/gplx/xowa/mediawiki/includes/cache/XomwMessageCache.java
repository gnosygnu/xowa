...
public class XomwMessageCache {
	private static final int FOR_UPDATE = 1; // force message reload
...
//	protected cache;
	 ...
	 * @var array
	 */
	protected XophpArray overridable;

	/**
	 * @var bool[] Map of (language code => boolean)
	 */
	protected XophpArray<Boolean> cacheVolatile = new XophpArray<>();
...
//	protected mExpiry;
	 ...
	 * @var ParserOptions
	 */
	protected XomwParserOptions mParserOptions;
	/** @var Parser */
	protected XomwParser mParser;

	/**
	 * @var bool mInParser
	 */
	protected boolean mInParser = false;
...
//	private loadedLanguages = [];
	 ...
	 */
	private static XomwMessageCache instance;
	 ...
	 * @return MessageCache
	 */
	public static XomwMessageCache singleton() {
		if (instance == null) {
//			global wgUseDatabaseMessages, wgMsgCacheExpiry, wgUseLocalMessageCache;
			XomwMediaWikiServices services = XomwMediaWikiServices.getInstance();
			instance = new XomwMessageCache(
