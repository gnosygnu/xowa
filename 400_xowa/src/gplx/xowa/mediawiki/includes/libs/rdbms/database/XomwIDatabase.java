package gplx.xowa.mediawiki.includes.libs.rdbms.database;
...
public interface XomwIDatabase {
     ...
     */
	public static final int QUERY_PSEUDO_PERMANENT = 2;
    /** @var int Enforce that a query does not make effective writes */
	public static final int QUERY_REPLICA_ROLE = 4;

    /** @var bool Parameter to unionQueries() for UNION ALL */
	public static final boolean UNION_ALL = true;
    /** @var bool Parameter to unionQueries() for UNION DISTINCT */
	public static final boolean UNION_DISTINCT = false;
     ...
     */
    public boolean bufferResults(boolean buffer); // buffer = null
//
//    /**
