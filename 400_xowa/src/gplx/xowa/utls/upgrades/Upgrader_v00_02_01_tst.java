...
public class Upgrader_v00_02_01_tst {
	@Test  public void Run() {
		...
		mgr.Run(wiki);
		Tfds.Eq_str_lines(Xow_cfg_wiki_core_tst.Const_wiki_core_cfg, Io_mgr._.LoadFilStr(wiki.Fsys_mgr().Cfg_wiki_core_fil()));
		Tfds.Eq_str_lines("/* assume content ... */", Io_mgr._.LoadFilStr(wiki.Fsys_mgr().Cfg_wiki_stats_fil()));
	}
