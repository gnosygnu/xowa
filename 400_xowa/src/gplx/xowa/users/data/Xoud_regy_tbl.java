...
//				conn.Meta_tbl_create(meta);
	...
	public void Update(String grp, String key, String val) {
		if (stmt_update == null) stmt_update = Db_stmt_.new_update_(conn, Tbl_name, StringUtl.Ary(Fld_regy_grp, Fld_regy_key), Fld_regy_val);
	...
	public void Select_by_grp(List_adp rv, String grp) {
		if (stmt_select_grp == null) stmt_select_grp = Db_stmt_.new_select_as_rdr(conn, Db_qry__select_in_tbl.new_(Tbl_name, StringUtl.Ary(Fld_regy_grp), Flds__all, Db_qry__select_in_tbl.Order_by_null));
	...
	public String Select_val(String grp, String key) {
		if (stmt_select_key == null) stmt_select_key = Db_stmt_.new_select_as_rdr(conn, Db_qry__select_in_tbl.new_(Tbl_name, StringUtl.Ary(Fld_regy_grp, Fld_regy_key), Flds__all, Db_qry__select_in_tbl.Order_by_null));
