...
class Xoud_opt_scope {
	...
	public String To_str() {
		String lang_str = lang_id == Lang_id_wildcard ? "*" : String_.new_utf8_(Xol_lang_itm_.Get_by_id(lang_id).Key());
		String type_str = type_id == Lang_id_wildcard ? "*" : String_.new_utf8_(Xow_domain_.Tid__get_bry(type_id));
...
class Xoud_opt_scope_parser {
	...
	public Xoud_opt_scope[] Parse(byte[] src) {
		...
		return (Xoud_opt_scope[])list.Xto_ary_and_clear(Xoud_opt_scope.class);
	}
	...
	private Xoud_opt_scope Warn(String fmt, byte[] src, int bgn, int end) {
		usr_dlg.Warn_many("", "", fmt, String_.new_utf8_(src, bgn, end));
		return Xoud_opt_scope.App;
	}
	private static final Btrie_slim_mgr btrie_by_type = Btrie_slim_mgr.cs_()
	.Add_str_int("w"			, Xow_domain_.Tid_int_wikipedia)
	.Add_str_int("d"			, Xow_domain_.Tid_int_wiktionary)
	.Add_str_int("s"			, Xow_domain_.Tid_int_wikisource)
	.Add_str_int("v"			, Xow_domain_.Tid_int_wikivoyage)
	.Add_str_int("q"			, Xow_domain_.Tid_int_wikiquote)
	.Add_str_int("b"			, Xow_domain_.Tid_int_wikibooks)
	.Add_str_int("u"			, Xow_domain_.Tid_int_wikiversity)
	.Add_str_int("n"			, Xow_domain_.Tid_int_wikinews)
	.Add_str_int("*"			, Xoud_opt_scope.Type_id_wildcard)
	.Add_str_int("xowa"			, Xow_domain_.Tid_int_home)
	.Add_str_int("wd"			, Xow_domain_.Tid_int_wikidata)
	.Add_str_int("c"			, Xow_domain_.Tid_int_commons)
	.Add_str_int("species"		, Xow_domain_.Tid_int_species)
	.Add_str_int("meta"			, Xow_domain_.Tid_int_meta)
	.Add_str_int("mw"			, Xow_domain_.Tid_int_mediawiki)
	.Add_str_int("wmf"			, Xow_domain_.Tid_int_wikimediafoundation)
	;
