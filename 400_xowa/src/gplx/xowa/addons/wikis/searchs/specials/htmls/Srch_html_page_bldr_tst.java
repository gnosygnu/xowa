...
public class Srch_html_page_bldr_tst {
	...
	@Test public void Rows() {
		fxt.Test_rows(new Srch_rslt_row[] {fxt.Make_row(10, "A"), fxt.Make_row(20, "B")}, StringUtl.ConcatLinesNlSkipLast
		( ""
...
class Srch_html_page_bldr_fxt {
	private Xoae_app app; private Xowe_wiki wiki; private Srch_html_page_bldr html_mgr; private final BryWtr tmp_bfr = BryWtr.NewWithSize(255);
	private int page_id;
	...
	public void Test_paging(boolean fwd, int slab_idx, String expd) {
		byte[] search_orig = BryUtl.NewA7("A");
		...
		GfoTstr.EqObj(expd, StringUtl.NewA7(paging_link));
	}
