...
class Srch_crt_sql_fxt {
	...
	public Srch_crt_sql_fxt Exec__new_or_null(String src_str) {
		this.actl = Srch_crt_sql.New_or_null(BryUtl.NewU8(src_str), Srch_search_addon.Wildcard__star);
		return this;
	}
	public Srch_crt_sql_fxt Test__tid(int expd)			{GfoTstr.EqObj(expd, actl.Tid); return this;}
	public Srch_crt_sql_fxt Test__eq(String expd)		{GfoTstr.EqObj(expd, actl.Eq); return this;}
	public Srch_crt_sql_fxt Test__rng_bgn(String expd)	{GfoTstr.EqObj(expd, actl.Rng_bgn); return this;}
	public Srch_crt_sql_fxt Test__rng_end(String expd)	{GfoTstr.EqObj(expd, actl.Rng_end); return this;}
	public Srch_crt_sql_fxt Test__like(String expd)		{GfoTstr.EqObj(expd, actl.Like); return this;}
	public Srch_crt_sql_fxt Test__pattern(String expd)	{GfoTstr.EqObj(expd, StringUtl.NewU8(actl.Pattern.Raw()), "pattern"); return this;}
}
