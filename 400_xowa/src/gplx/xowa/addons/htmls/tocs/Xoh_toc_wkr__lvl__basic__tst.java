...
public class Xoh_toc_wkr__lvl__basic__tst {
	...
	@Test public void D1_S0_S0() {
		fxt.Test__calc(2, fxt.Make(1, 1, IntAryUtl.New(1)));
		fxt.Test__calc(2, fxt.Make(2, 1, IntAryUtl.New(2)));
		fxt.Test__calc(2, fxt.Make(3, 1, IntAryUtl.New(3)));
	}
	@Test public void D1_D1_D1() {
		fxt.Test__calc(2, fxt.Make(1, 1, IntAryUtl.New(1)));
		fxt.Test__calc(3, fxt.Make(2, 2, IntAryUtl.New(1, 1)));
		fxt.Test__calc(4, fxt.Make(3, 3, IntAryUtl.New(1, 1, 1)));
	}
	@Test public void D1_D1_S0_U1() {
		fxt.Test__calc(2, fxt.Make(1, 1, IntAryUtl.New(1)));
		fxt.Test__calc(3, fxt.Make(2, 2, IntAryUtl.New(1, 1)));
		fxt.Test__calc(3, fxt.Make(3, 2, IntAryUtl.New(1, 2)));
		fxt.Test__calc(2, fxt.Make(4, 1, IntAryUtl.New(2)));
	}
	@Test public void D1_D1_U1_D1() {
		fxt.Test__calc(2, fxt.Make(1, 1, IntAryUtl.New(1)));
		fxt.Test__calc(3, fxt.Make(2, 2, IntAryUtl.New(1, 1)));
		fxt.Test__calc(2, fxt.Make(3, 1, IntAryUtl.New(2)));
		fxt.Test__calc(3, fxt.Make(4, 2, IntAryUtl.New(2, 1)));
	}
...
class Xoh_toc_wkr__lvl__fxt {
	...
	public void Test__calc(int lvl, Xoh_toc_itm expd) {
		...
		GfoTstr.Eq(expd.Uid(), actl.Uid(), "uid");
		GfoTstr.Eq(expd.Lvl(), actl.Lvl(), "lvl");
		Gftest.EqAry(expd.Path(), actl.Path(), "path");
	}
}
