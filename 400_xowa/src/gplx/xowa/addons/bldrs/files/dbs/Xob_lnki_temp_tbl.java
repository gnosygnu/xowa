...
public class Xob_lnki_temp_tbl implements Db_tbl {
	...
	public static final String
	  Fld_lnki_id				= flds.AddIntPkeyAutonum("lnki_id");	// NOTE: insertion order index; public b/c not used and want to bypass warning
	private static final String
	  Fld_lnki_tier_id			= flds.AddInt("lnki_tier_id")
	, Fld_lnki_page_id			= flds.AddInt("lnki_page_id")
	, Fld_lnki_ttl				= flds.AddStr("lnki_ttl", 255)
	, Fld_lnki_commons_ttl		= flds.AddStrNull("lnki_commons_ttl", 255)
	, Fld_lnki_ext				= flds.AddInt("lnki_ext")
	, Fld_lnki_type				= flds.AddInt("lnki_type")
	, Fld_lnki_src_tid			= flds.AddInt("lnki_src_tid")
	, Fld_lnki_w				= flds.AddInt("lnki_w")
	, Fld_lnki_h				= flds.AddInt("lnki_h")
	, Fld_lnki_upright			= flds.AddDouble("lnki_upright")
	, Fld_lnki_time				= flds.AddDouble("lnki_time")	// NOTE: thumbtime is float; using double b/c upright is double and would like to keep datatypes same; https://bugzilla.wikimedia.org/show_bug.cgi?id=39014
