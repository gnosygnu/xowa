...
public class Xobc_task_key {
	...
	public String Wiki_date_ui() {return StringUtl.Replace(wiki_date, ".", "-");}
	public String Task_type() {return task_type;} private final String task_type;
	public String Task_type_ui() {
		if		(StringUtl.Eq(task_type, "html"))		return "Articles";
		else if	(StringUtl.Eq(task_type, "file"))		return "Images";
		else if	(StringUtl.Eq(task_type, "text"))		return "Source";
		else if	(StringUtl.Eq(task_type, "patch"))	return "Patch";
		else										return task_type;
	}
	public Xow_domain_itm Wiki_domain_itm() {return Xow_domain_itm_.parse(BryUtl.NewU8(wiki_domain));}

	public static Xobc_task_key To_itm(String task_key) {
		String[] ary = StringUtl.Split(task_key, "|");
	...
	public static String To_str(String wiki_domain, String wiki_date, String task_type) {
		return StringUtl.Concat(wiki_domain, "|", wiki_date, "|", task_type);
	}
}
