...
public abstract class Merge2_wkr__heap_base implements Merge2_wkr {
	...
	public abstract void Copy_to_wiki(Merge_ctx ctx, Merge_prog_wkr prog_wkr, String tbl_name, DbmetaFldList src_flds, Db_conn src_conn, Merge2_trg_itm trg_db, String[] fld_pkeys);
}
