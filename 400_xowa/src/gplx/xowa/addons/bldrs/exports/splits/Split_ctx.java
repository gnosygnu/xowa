...
public class Split_ctx {		
	...
	private long trg_max = 32 * IoConsts.LenMB;
	...
	public Io_url Trg_db__make(int ns_id) {
		// create new trg_conn
		String trg_name = Split_file_tid_.Make_file_name(StringUtl.NewU8(wiki.Domain_itm().Abrv_wm()), wiki.Props().Modified_latest().ToStrFmt("yyyy.MM"), ++trg_idx, ns_id, ".xowa");
