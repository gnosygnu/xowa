...
class Xob_sync_grp {
	...
	public Xob_sync_grp Ctor_itm(GfoDate dump_time, GfoDate upload_time) {
		this.dump_time = dump_time; this.upload_time = upload_time;
		return this;
	}
	public GfoDate Dump_time() {return dump_time;} private GfoDate dump_time;
	public GfoDate Upload_time() {return upload_time;} private GfoDate upload_time;
	public int Itms__len() {return itms.Len();}
	public void Itms__add(Xob_sync_pkg file) {itms.Add(file.Path(), file);}
	public Xob_sync_pkg Itms__get_at(int i) {return (Xob_sync_pkg)itms.GetAt(i);}
}
class Xob_sync_pkg extends Xob_sync_fil {	private final Ordered_hash itms = Ordered_hash_.New();
	...
	public Xob_sync_fil Itms__get_at(int i) {return (Xob_sync_fil)itms.GetAt(i);}
}
class Xob_sync_fil {
	public Xob_sync_fil Ctor_file(String path, String name, int ext, long len, GfoDate modified, String hash) {
	...
	public GfoDate Modified() {return modified;} private GfoDate modified;
