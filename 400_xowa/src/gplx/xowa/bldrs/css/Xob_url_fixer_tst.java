...
class Xob_url_fixer_fxt {
	public void Site_(String v) {site_bry = BryUtl.NewU8(v);} private byte[] site_bry;
	public void Clear() {
		this.Site_("site");
	}
	public void Test_fix(String raw, String expd) {
		byte[] raw_bry = BryUtl.NewU8(raw);
		GfoTstr.EqObj(expd, StringUtl.NewU8(Xob_url_fixer.Fix(site_bry, raw_bry, raw_bry.length)));
	}
}	
