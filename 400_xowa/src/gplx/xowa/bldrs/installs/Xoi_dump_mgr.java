...
public class Xoi_dump_mgr {
	...
	public static String[] Server_urls(Xoa_app app)	{
		String[] or = StringUtl.Ary(Xowm_dump_file_.Server_your_org, Xowm_dump_file_.Server_wmf_https, Xowm_dump_file_.Server_c3sl, Xowm_dump_file_.Server_masaryk);	// promote your.org to primary url; DATE:2016-08-07
