...
public class Xob_info_session {
	Xob_info_session(String user, String version, String wiki_domain, String dump_name, GfoDate time, GfoGuid guid) {
	...
	public GfoDate Time() {return time;} private final GfoDate time;
	public GfoGuid Uuid() {return guid;} private final GfoGuid guid;
	...
	public static Xob_info_session Load(Db_cfg_tbl tbl) {
		...
		, hash.Get_by(Cfg_key__time).To_date_or(GfoDateUtl.MinValue)
	...
	;
	public static Xob_info_session new_(String user, String wiki_domain, String dump_name) {return new Xob_info_session(user, Xoa_app_.Version, wiki_domain, dump_name, GfoDateNow.Get(), GfoGuidUtl.New());}
