...
class Xob_ttl_filter_mgr_fxt {
	...
	public void Init_load_exclude(String itm) {mgr.Load(BoolUtl.Y, Bry_.new_u8(itm));}
	public void Init_load_include(String itm) {mgr.Load(BoolUtl.N, Bry_.new_u8(itm));}
