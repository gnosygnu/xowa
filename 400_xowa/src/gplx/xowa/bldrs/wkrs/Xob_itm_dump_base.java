...
public abstract class Xob_itm_dump_base extends Xob_itm_basic_base {
	protected int sort_mem_len = IntUtl.Neg1, dump_fil_len = IntUtl.Neg1, make_fil_len = IntUtl.Neg1;
	...
	public void Init_dump(String tmp_dir_key, Io_url make_dir_val) {
		if (sort_mem_len == IntUtl.Neg1) sort_mem_len = bldr.Sort_mem_len();
		if (dump_fil_len == IntUtl.Neg1) dump_fil_len = bldr.Dump_fil_len();
		if (make_fil_len == IntUtl.Neg1) make_fil_len = bldr.Make_fil_len();
		dump_bfr = BryWtr.NewWithSize(dump_fil_len);
