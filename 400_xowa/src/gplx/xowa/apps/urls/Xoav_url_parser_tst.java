...
class Xoav_url_parser_fxt {
	...
	public void Clear() {
		cur_wiki = BryUtl.NewA7("en.wikipedia.org");
		url.Clear();
	}
	public Xoav_url_parser_fxt Init_cur_wiki(String v) {cur_wiki = BryUtl.NewU8(v); return this;} private byte[] cur_wiki;
	public Xoav_url_parser_fxt Test_wiki(String v) {GfoTstr.Eq(BryUtl.NewU8(v), url.Wiki_bry()); return this;}
	public Xoav_url_parser_fxt Test_page(String v) {GfoTstr.Eq(BryUtl.NewU8(v), url.Page_bry()); return this;}
