...
public class Xowm_dump_file_ {
	public static Xowm_dump_file parse(byte[] src) {
		...
		int dash_0 = Bry_finder.Find_fwd(src, Byte_ascii.Dash, 0			, src_len); if (dash_0 == Bry_.NotFound) throw Err_.new_parse_type(Xowm_dump_file.class, String_.new_u8(src));
		int dash_1 = Bry_finder.Find_fwd(src, Byte_ascii.Dash, dash_0 + 1	, src_len); if (dash_1 == Bry_.NotFound) throw Err_.new_parse_type(Xowm_dump_file.class, String_.new_u8(src));
