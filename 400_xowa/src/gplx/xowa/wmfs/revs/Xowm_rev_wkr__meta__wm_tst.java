...
import org.junit.*; import gplx.core.json.*; import gplx.core.net.*;
...
class Xowm_rev_wkr__meta__wm_fxt {
	private final byte[] domain_bry = Xow_domain_itm_.Bry__enwiki;
	...
	public void Init_inet_upload(Wmapi_itm__pge... ary) {
		...
		inet_conn.Clear();
		inet_conn.Upload_data(domain_bry, page);
	}
	public void Test_fetch(String[] ttl_ary, Wmapi_itm__pge... expd) {
		Init_rev_hash(ttl_ary);
		meta_wkr.Fetch_meta(domain_bry, rev_hash, 0, rev_hash.Count());
