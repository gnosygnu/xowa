...
//			wtr.Write_js_tail_load_lib(app.Fsys_mgr().Bin_any_dir().GenSubFil_nest("xowa", "html", "modules", "mw.toc", "mw.toc.js"));
	...
	private static final byte[]
	  Key_exists				= BryUtl.NewA7("toc-enabled")
	, Key_collapsed				= BryUtl.NewA7("mw_hidetoc")
	, Val_collapsed_y			= BryUtl.NewA7("1")
	, Val_collapsed_n			= BryUtl.NewA7("0")
	;
	public static final byte[]
	  Key_showtoc				= BryUtl.NewA7("showtoc")
	, Key_hidetoc				= BryUtl.NewA7("hidetoc")
	;
}
