...
public class Xow_hzip_itm__anchor_tst {
	...
	@Test   public void Srl_lnki_text_y__html() {	// PURPOSE: PAGE:en.w:Abyssal_plain; DATE:2015-06-02
		byte[][] brys = Bry_.Ary(Xow_hzip_dict.Bry_lnki_text_y, Bry_.new_ints(2), fxt.Make_int(3), Bry_.new_a7("A"), Xow_hzip_dict.Escape_bry, Bry_.new_a7("<font color='white'>A1</font>"), Xow_hzip_dict.Bry_a_rhs);
