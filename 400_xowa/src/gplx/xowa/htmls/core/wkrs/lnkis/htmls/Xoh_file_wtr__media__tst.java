...
public class Xoh_file_wtr__media__tst {		
	...
	@Test public void Page_only() { // if no caption, then use page name; DATE:2017-05-20
		fxt.Test_parse_page_wiki_str("[[Media:A.png]]", StringUtl.ConcatLinesNlSkipLast
	...
	@Test public void Nested_caption() { // PAGE:en.w:Beethoven;
		fxt.Test_parse_page_wiki_str("[[File:A.png|thumb|b [[Media:A.ogg|media_caption]] c]]", StringUtl.ConcatLinesNlSkipLast
	...
	@Test public void Caption() {
		fxt.Test_parse_page_wiki_str("[[Media:A.png|b]]", StringUtl.ConcatLinesNlSkipLast
		( "<a href=\"file:///mem/wiki/repo/trg/orig/7/0/A.png\" xowa_title=\"A.png\">b</a>"
		));
	}
	@Test public void Literal() {
		fxt.Test_parse_page_wiki_str("[[:Media:A.ogg|b]]", StringUtl.ConcatLinesNlSkipLast
	...
	@Test public void Literal_w_missing() {
		...
		fxt.Test_parse_page_wiki_str("[[Media:A.pdf|b]]", StringUtl.ConcatLinesNlSkipLast
		( "<a href=\"file:///mem/wiki/repo/trg/orig/e/f/A.pdf\" xowa_title=\"A.pdf\">b</a>"
		));
		GfoTstr.EqObj(0, fxt.Page().File_queue().Count());			// make sure media does not add to queue
