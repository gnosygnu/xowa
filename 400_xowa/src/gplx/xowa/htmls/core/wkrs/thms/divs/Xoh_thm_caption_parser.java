...
public class Xoh_thm_caption_parser {
	...
	public boolean Parse(Xoh_hdoc_wkr hdoc_wkr, Html_tag_rdr tag_rdr, byte[] src, Html_tag capt_head) {
	...
	private void Alt_div_exists(Html_tag_rdr tag_rdr, byte[] src) {
		...
		Html_tag nxt_div_tail = tag_rdr.Tag__peek_fwd_tail(Html_tag_.Id__div); 
		Html_tag nxt_tag = tag_rdr.Tag__find_fwd_head(tag_rdr.Pos(), nxt_div_tail.Src_bgn(), Html_tag_.Id__hr); 
