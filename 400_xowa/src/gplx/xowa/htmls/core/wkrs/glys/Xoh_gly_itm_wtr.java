...
public class Xoh_gly_itm_wtr implements BryBfrArg, Js_img_wkr {
	...
	public Xoh_gly_itm_wtr() {
		arg_ary = new BryBfrArgClearable[] {li_id, div_1_id, div_2_id, div_3_id, img_id};
	}
	...
	public void AddToBfr(BryWtr bfr) {
		fmtr.BldToBfrMany(bfr, li_id, div_1_id, div_2_id, div_3_id, div_1_w, div_2_w, div_3_margin, img_wtr, itm_caption_fmtr);
	}
	...
	public void Js_wkr__update_hdoc(Xoa_page page, Xog_js_wkr js_wkr, int html_uid, int html_w, int html_h, Io_url html_view_url, int orig_w, int orig_h, Xof_ext orig_ext, Io_url html_orig_url, byte[] lnki_ttl) {
		...
		fmtr.BldToBfrMany(bfr, li_id, div_1_id, div_2_id, div_3_id, div_1_w, div_2_w, div_3_margin, img_wtr, itm_caption_fmtr);
		js_wkr.Html_elem_replace_html(StringUtl.NewU8(li_id.Get_id_val()), bfr.ToStrAndClear());
...
class Bfr_arg__itm_caption implements BryBfrArg {
	...
	public void AddToBfr(BryWtr bfr) {
		...
		switch (capt_tid) {
			...
			case Xoh_gly_itm_data.Capt_tid__p:			bfr.AddByteNl().Add(Gfh_tag_.P_lhs); break;		// <div class='gallerytext'><p>
			case Xoh_gly_itm_data.Capt_tid__br:			bfr.Add(Gfh_tag_.Br_lhs).AddByteNl(); break;		// <div class='gallerytext'><br>
			case Xoh_gly_itm_data.Capt_tid__p_wo_rhs:	bfr.AddByteNl().Add(Gfh_tag_.P_lhs); break;		// <div class='gallerytext'><br>
		}
		bfr.Add(capt_bry);
		int itm_caption_len = capt_bry.length;
		if (capt_tid == Xoh_gly_itm_data.Capt_tid__p) {
			if (itm_caption_len > 3 && BryLni.Eq(capt_bry, itm_caption_len - 4, Gfh_tag_.Br_lhs)) bfr.AddByteNl();
