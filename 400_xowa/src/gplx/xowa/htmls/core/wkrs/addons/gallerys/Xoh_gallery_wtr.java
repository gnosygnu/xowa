...
public class Xoh_gallery_wtr implements BryBfrArg, Xoh_wtr_itm {
	private Xoh_page hpg;
	private byte[] src; private int src_bgn, src_end;
	public void Init_by_parse(BryWtr bfr, Xoh_page hpg, Xoh_hdoc_ctx hctx, byte[] src, Xoh_gallery_data data) {
