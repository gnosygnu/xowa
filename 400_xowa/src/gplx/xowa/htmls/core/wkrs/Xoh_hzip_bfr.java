...
public class Xoh_hzip_bfr extends BryWtr { 	private final Xoh_hzip_int hzint = new Xoh_hzip_int();
	...
	public Xoh_hzip_bfr Add_hzip_bry(byte[] bry)					{Add(bry);					AddByte(stop_byte); return this;}
	public Xoh_hzip_bfr Add_hzip_mid(byte[] src, int bgn, int end)	{AddMid(src, bgn, end);	AddByte(stop_byte); return this;}
	public Xoh_hzip_bfr Add_hzip_double(double val)					{this.AddDouble(val);		AddByte(stop_byte); return this;}
