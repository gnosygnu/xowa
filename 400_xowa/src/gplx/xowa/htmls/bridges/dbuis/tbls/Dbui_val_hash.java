...
*/
package gplx.xowa.htmls.bridges.dbuis.tbls; import gplx.*;
public class Dbui_val_hash {
	...
	public byte[] Get_val_as_bry(byte[] key) {
		Dbui_val_itm itm = (Dbui_val_itm)hash.GetByOrNull(key); if (itm == null) throw Err_.new_wo_type("dbui.val_hash; unknown key", "key", key);
		return itm.Data();
	}
}
