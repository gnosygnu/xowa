...
class Xoh_page_body_cls_fxt {
	private BryWtr tmp_bfr; private Xoae_app app; private Xowe_wiki wiki;
	public void Test_escape_cls(String raw, String expd) {
		GfoTstr.EqObj(expd, StringUtl.NewU8(Xoh_page_body_cls.Escape_cls(BryUtl.NewU8(raw))));
	}
	public void Test_calc(byte page_tid, String ttl_str, String expd) {
		if (app == null) {
			app = Xoa_app_fxt.Make__app__edit();
			wiki = Xoa_app_fxt.Make__wiki__edit(app);
			tmp_bfr = BryWtr.NewAndReset(255);
		...
		GfoTstr.EqObj(expd, StringUtl.NewU8(Xoh_page_body_cls.Calc(tmp_bfr, ttl, page_tid)));
	}
}
