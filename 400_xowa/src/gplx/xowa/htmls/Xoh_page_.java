...
import gplx.xowa.*;
import gplx.xowa.wikis.pages.skins.*; import gplx.xowa.wikis.pages.htmls.*;
public class Xoh_page_ {
	public static byte[] Save_sidebars(BryWtr tmp_bfr, Xoae_page page, Xopg_html_data html_data) {
		...
		return sidebar_exists ? tmp_bfr.ToBryAndClear() : null;
	}
}
