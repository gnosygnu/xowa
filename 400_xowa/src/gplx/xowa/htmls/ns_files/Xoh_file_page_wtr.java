...
public class Xoh_file_page_wtr {
	...
	public byte[]	Html_alt_dlm_dflt()	{return html_alt_dlm_dflt;} private byte[] html_alt_dlm_dflt = BryUtl.NewA7("|");
	public byte[]	Html_alt_dlm_last()	{return html_alt_dlm_last;} private byte[] html_alt_dlm_last = BryUtl.NewA7(".");
	public BryFmtr Html_main() {return html_main;} private final BryFmtr html_main = BryFmtr.New(StringUtl.ConcatLinesNlSkipLast
	( "~{commons_notice}<br/>"
//		, "<ul id=\"filetoc\">"
//		, "  <li>"
//		, "    <a href=\"#file\">"
...
//		, "</ul>"
	...
	public BryFmtr Html_main_img() {return html_main_img;} private final BryFmtr html_main_img = BryFmtr.New(StringUtl.ConcatLinesNlSkipLast
...
//		, "    </span>"
	...
	public BryFmtr Html_main_aud() {return html_main_aud;} private final BryFmtr html_main_aud = BryFmtr.New(StringUtl.ConcatLinesNlSkipLast
	( "<div class=\"fullImageLink\" id=\"file\">"
	...
	public BryFmtr Html_main_vid() {return html_main_vid;} private final BryFmtr html_main_vid = BryFmtr.New(StringUtl.ConcatLinesNlSkipLast
	( "<div class=\"fullImageLink\" id=\"file\">"
	, "  <div>" 
	...
	public BryFmtr Html_alts() {return html_alts;} private final BryFmtr html_alts = BryFmtr.New(StringUtl.ConcatLinesNlSkipLast
