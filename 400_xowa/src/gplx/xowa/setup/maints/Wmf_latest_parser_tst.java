...
public class Wmf_latest_parser_tst {
	...
	@Test  public void Parse() {
		fxt.Test_parse
		( "<tr><td class=\"n\"><a href=\"enwiki-latest-pages-articles.xml.bz2\">enwiki-latest-pages-articles.xml.bz2</a></td><td class=\"m\">2014-Dec-10 06:53:20</td><td class=\"s\">10.7G</td><td class=\"t\">application/x-bzip</td></tr>"
		, fxt.itm("enwiki-latest-pages-articles.xml.bz2", "2014-12-10 06:53:20", "10.7 GB")
		);
	}
...
class Wmf_latest_parser_fxt {
	...
	public Wmf_latest_itm itm(String name, String date, String size) {return new Wmf_latest_itm(Bry_.new_ascii_(name), DateAdp_.parse_iso8561(date), Io_size_.parse_or_(size, 0));}
	public void Test_parse(String raw, Wmf_latest_itm... expd) {
		parser.Parse(Bry_.new_ascii_(raw));
		Wmf_latest_itm[] actl = parser.Xto_ary();
	...
	public static String Xto_str(Wmf_latest_itm itm) {
		return String_.Concat_with_str("\n", String_.new_ascii_(itm.Name()), itm.Date().XtoStr_fmt_iso_8561(), Io_size_.Xto_str(itm.Size()));			
	}
}
