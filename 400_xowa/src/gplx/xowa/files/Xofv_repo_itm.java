...
public class Xofv_repo_itm {
	...
	public static Xofv_repo_itm new_trg_fsys(byte tid, byte[] key, Io_url root) {
		return new Xofv_repo_itm(tid, key, root.Info().DirSpr_byte(), BryUtl.NewU8(root.Raw()), Dir_sub_orig_dflt, Dir_sub_thumb_dflt);
	}
	public static final byte Tid_val_comm = 0, Tid_val_wiki = 1;
	private static final byte[] Dir_sub_orig_dflt = BryUtl.NewA7("orig"), Dir_sub_thumb_dflt = BryUtl.NewA7("thumb");
