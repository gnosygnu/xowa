...
import org.junit.*;
import gplx.fsdb.*;
public class Xof_offline_pdf_tst {
	...
	@Test  public void Copy_thumb() {// PURPOSE: download pdf thumb only; [[File:Physical world.pdf|thumb]]
		...
		fxt.Init_qry_xowa(Xof_fsdb_arg_init_qry.new_().Init_commons("A.pdf", 2200, 1700));
		fxt.Init_bin_fsdb(Xof_fsdb_arg_init_bin.new_().Init_commons_thumb("A.pdf", 220, 170));
		fxt.Exec_get(Xof_fsdb_arg_exec_get.new_().Init_thumb("A.pdf", 220));
