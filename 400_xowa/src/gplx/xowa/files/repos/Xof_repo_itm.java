...
public class Xof_repo_itm implements GfoInvkAble {
	...
	public Xof_repo_itm(byte[] key, Xoa_fsys_mgr app_fsys, Xof_rule_mgr ext_rule_mgr) {
	...
	public Xof_rule_grp Ext_rules() {return ext_rules;} public Xof_repo_itm Ext_rules_(Xof_rule_grp v) {ext_rules = v; return this;} private Xof_rule_grp ext_rules;
	...
	public Xof_repo_itm Root_str_(String v) {
		...
		if (wmf_fsys) {
			...
			root_url = App_cmd_arg.Val_as_url_rel_url_or(root_str, app_fsys.File_dir(), Io_url_.new_dir_(root_str), true);
			dir_spr = root_url.Info().DirSpr_byte();
			root_http = root_url.To_http_file_bry();
	...
	public Object Invk(GfsCtx ctx, int ikey, String k, GfoMsg m) {
		if		(ctx.Match(k, Invk_owner))				throw Err_.not_implemented_msg_("deprecated repo_itm.owner");
