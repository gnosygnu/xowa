...
public class Xof_repo_tid_ {
	...
	, Tid__null		= ByteUtl.MaxValue127
	;
	public static byte By_str(String v) {
		if		(StringUtl.Eq(v, "self")) return Tid__local;
		else if	(StringUtl.Eq(v, "comm")) return Tid__remote;
		else if	(StringUtl.Eq(v, "math")) return Tid__math;
		else							throw ErrUtl.NewUnhandled(v);
	}
	public static final byte[]
	  Bry__math		= BryUtl.NewA7("wikimedia.org/math")	// EX: https://wikimedia.org/api/rest_v1/media/math/render/svg/596f8baf206a81478afd4194b44138715dc1a05c
	;
}
