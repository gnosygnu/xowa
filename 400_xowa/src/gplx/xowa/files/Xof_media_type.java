...
public class Xof_media_type {
	...
	public static byte Xto_byte(String v) {
		if		(StringUtl.Eq(v, Name_audio))		return Tid_audio;
		else if	(StringUtl.Eq(v, Name_bitmap))	return Tid_bitmap;
		else if	(StringUtl.Eq(v, Name_drawing))	return Tid_drawing;
		else if	(StringUtl.Eq(v, Name_office))	return Tid_office;
		else if	(StringUtl.Eq(v, Name_video))		return Tid_video;
