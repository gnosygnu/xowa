...
public class Xows_diag_page implements Xow_special_page {
	...
	public void Special__gen(Xow_wiki wikii, Xoa_page pagei, Xoa_url url, Xoa_ttl ttl) {
		...
		ByteVal cmd_type_val = (ByteVal)type_hash.Get_by_bry(cmd_type_bry);	if (cmd_type_val == null) {Xoa_app_.Usr_dlg().Warn_many("", "", "special.cmd; bad type: url=~{0}", url.Raw()); return;}
		...
		bfr.AddStrA7("</pre>\n");
		page.Db().Text().Text_bry_(bfr.ToBryAndClear());
	}
