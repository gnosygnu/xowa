...
public class Default_tab_page implements Xow_special_page {
	...
	public void Special__gen(Xow_wiki wiki, Xoa_page pagei, Xoa_url url, Xoa_ttl ttl) {
		...
		page.Db().Text().Text_bry_(BryUtl.Empty);
	...
	public static final byte[] Tab_name_bry = BryUtl.NewA7("New Tab");

	public Xow_special_page Special__clone() {return this;}

	public static final byte[]
	  DEFAULT_HTML_DAY   = BryUtl.NewA7("<html><body style='background-color:white'></body></html>")
	, DEFAULT_HTML_NIGHT = BryUtl.NewA7("<html><body style='background-color:black'></body></html>")
	;
}
