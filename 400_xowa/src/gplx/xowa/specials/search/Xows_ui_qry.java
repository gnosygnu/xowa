...
class Xows_ui_qry {
	private final ListAdp cmd_list = ListAdp_.new_();
	public Xows_ui_qry(byte[] search_raw, int page_idx, int page_len, byte sort_tid, Xows_ns_mgr ns_mgr, boolean async_db, byte[][] wiki_domains) {
	...
	public byte[][] Wiki_domains() {return wiki_domains;} private byte[][] wiki_domains;
	public void Page_max_(int v) {this.page_max = v;}
	public int Cmds__len() {return cmd_list.Count();}
	public Xows_ui_cmd Cmds__get_at(int i) {return (Xows_ui_cmd)cmd_list.FetchAt(i);}
