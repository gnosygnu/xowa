...
public class Xoa_special_regy {
	...
	public Xow_special_page Get_at(int i)					{return (Xow_special_page)hash.GetAt(i);}
	public Xow_special_page Get_by_or_null(byte[] key)		{return (Xow_special_page)hash.GetByOrNull(key);}
