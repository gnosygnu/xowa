...
public class Xol_grammar_ {
	...
	public static final byte Tid_genitive = 0, Tid_elative = 1, Tid_partitive = 2, Tid_illative = 3, Tid_inessive = 4, Tid_accusative = 5, Tid_instrumental = 6, Tid_prepositional = 7, Tid_dative = 8, Tid_unknown = ByteUtl.MaxValue127;
	...
	public static byte Tid_of_type(byte[] v) {
		if (BryUtl.IsNullOrEmpty(v)) return Tid_unknown;
		Object o = Xol_grammar_.Tid_trie.Match_exact(v, 0, v.length);
		return o == null ? Tid_unknown : ((ByteVal)o).Val();
	}
...
class Xol_grammar__unimplemented implements Xol_grammar {
	public boolean Grammar_eval(BryWtr bfr, Xol_lang_itm lang, byte[] word, byte[] type) {return false;}
...
class Xol_grammar__noop implements Xol_grammar {
	public boolean Grammar_eval(BryWtr bfr, Xol_lang_itm lang, byte[] word, byte[] type) {bfr.Add(word); return true;}
