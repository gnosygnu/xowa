...
class Xow_mainpage_finder_fxt {
	...
	public void Init_siteinfo(String mainpage_val) {
		fxt.Wiki().Props().Main_page_(BryUtl.NewA7(mainpage_val));
	}
	public void Init_mediawiki_page(String mainpage_val) {
		fxt.Init_page_create(StringUtl.NewA7(Ttl_mainpage), mainpage_val);
	}	private static final byte[] Ttl_mainpage = BryUtl.NewA7("MediaWiki:Mainpage"); // TEST:
	public void Init_lang(String mainpage_val) {
		...
		msg_itm.Atrs_set(BryUtl.NewA7(mainpage_val), false, false);
	}
