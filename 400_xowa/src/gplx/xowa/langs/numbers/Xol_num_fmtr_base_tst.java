...
public class Xol_num_fmtr_base_tst {
	...
	Xol_num_grp dat_(String dlm, int digits)				{return new Xol_num_grp(BryUtl.NewU8(dlm), digits, true);}
	Xol_num_grp dat_(String dlm, int digits, boolean repeat)	{return new Xol_num_grp(BryUtl.NewU8(dlm), digits, repeat);}
	private void tst_Fmt(String val, String expd) {GfoTstr.EqObj(expd, StringUtl.NewU8(mgr.Fmt(BryUtl.NewU8(val))));}
	private void tst_Raw(String val, String expd) {GfoTstr.EqObj(expd, StringUtl.NewU8(mgr.Raw(Xol_num_fmtr_base.Tid_raw, BryUtl.NewU8(val))));}
	private void ini_(String dec_dlm, Xol_num_grp... ary) {
		mgr.Dec_dlm_(BryUtl.NewU8(dec_dlm));
