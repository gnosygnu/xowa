...
public class Pft_func_date_utc_tst {
	...
	@Before	public void setup()						{fxt.Reset(); GfoDateNow.ManualSet(GfoDateUtl.New(2011, 12, 31, 22, 4, 5, 6));}	// ENV:Assumes Eastern Standard Time (-5)
	@After public void teardown()				{GfoDateNow.ManualSetN();}
