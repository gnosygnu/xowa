...
public class Pft_fmt_itm_ {
	...
	, Byte_comma				= new Pft_fmt_itm_raw_byt(AsciiByte.Comma)
	, Byte_dash					= new Pft_fmt_itm_raw_byt(AsciiByte.Dash)
	...
	, Timezone_id_full          = new Pft_fmt_itm_timezone_id(BoolUtl.N)
	, Timezone_id_abrv          = new Pft_fmt_itm_timezone_id(BoolUtl.Y)
	, Timezone_offset_4         = new Pft_fmt_itm_timezone_offset_4(BoolUtl.N)
	, Timezone_offset_4_colon   = new Pft_fmt_itm_timezone_offset_4(BoolUtl.Y)
	;
	public static final Btrie_fast_mgr Regy = Btrie_fast_mgr.cs()
	.Add(AsciiByte.Ltr_Y		, Pft_fmt_itm_.Year_len4)				// 2012
	.Add(AsciiByte.Ltr_y		, Pft_fmt_itm_.Year_len2)				// 12
	.Add(AsciiByte.Ltr_L		, Pft_fmt_itm_.Year_isLeap)				// 1,0
	.Add(AsciiByte.Ltr_o		, Pft_fmt_itm_.Year_len4)				// 2012: ISO-8601; don't know why it's different vs Ltr_Y
	.Add(AsciiByte.Ltr_n		, Pft_fmt_itm_.Month_int)				// 1
	.Add(AsciiByte.Ltr_m		, Pft_fmt_itm_.Month_int_len2)			// 01
	.Add(AsciiByte.Ltr_M		, Pft_fmt_itm_.Month_abrv)				// Jan
	.Add(AsciiByte.Ltr_F		, Pft_fmt_itm_.Month_name)				// January
	.Add("xg"                   , Pft_fmt_itm_.Month_gen)				// January
	.Add(AsciiByte.Ltr_W		, Pft_fmt_itm_.WeekOfYear_int_len2)		// 01
	.Add(AsciiByte.Ltr_j		, Pft_fmt_itm_.Day_int)					// 1
	.Add(AsciiByte.Ltr_d		, Pft_fmt_itm_.Day_int_len2)			// 01
	.Add(AsciiByte.Ltr_z		, Pft_fmt_itm_.DayOfYear_int)			// 0
	.Add(AsciiByte.Ltr_D		, Pft_fmt_itm_.Dow_abrv)				// Sun
	.Add(AsciiByte.Ltr_l		, Pft_fmt_itm_.Dow_name)				// Sunday
	.Add(AsciiByte.Ltr_N		, Pft_fmt_itm_.Dow_base0_int)			// 1; Sunday=7
	.Add(AsciiByte.Ltr_w		, Pft_fmt_itm_.Dow_base1_int)			// 1; Sunday=0
	.Add(AsciiByte.Ltr_a		, Pft_fmt_itm_.AmPm_lower)				// am/pm
	.Add(AsciiByte.Ltr_A		, Pft_fmt_itm_.AmPm_upper)				// AM/PM
	.Add(AsciiByte.Ltr_g		, Pft_fmt_itm_.Hour_base12)				// 1;  Base12
	.Add(AsciiByte.Ltr_h		, Pft_fmt_itm_.Hour_base12_len2)		// 01; Base12; pad2
	.Add(AsciiByte.Ltr_G		, Pft_fmt_itm_.Hour_base24)				// 13; Base24;
	.Add(AsciiByte.Ltr_H		, Pft_fmt_itm_.Hour_base24_len2)		// 13; Base24; pad2
	.Add(AsciiByte.Ltr_i		, Pft_fmt_itm_.Minute_int_len2)			// 04
	.Add(AsciiByte.Ltr_s		, Pft_fmt_itm_.Second_int_len2)			// 05
	.Add(AsciiByte.Ltr_t		, Pft_fmt_itm_.DaysInMonth_int)			// 31
	.Add(AsciiByte.Ltr_U		, Pft_fmt_itm_.Timestamp_unix)			// 1343865600
	.Add(AsciiByte.Ltr_Z		, Pft_fmt_itm_.Timezone_offset)			// timezone offset in seconds
	.Add(AsciiByte.Ltr_c		, Pft_fmt_itm_.Iso_fmt)					// 2012-01-02T03:04:05+00:00
	.Add(AsciiByte.Ltr_r		, Pft_fmt_itm_.Rfc_5322)				// Mon 02 Jan 2012 08:04:05 +0000
	.Add(AsciiByte.Ltr_e       , Pft_fmt_itm_.Timezone_id_full)        // UTC
	.Add(AsciiByte.Ltr_T       , Pft_fmt_itm_.Timezone_id_abrv)        // UTC
	.Add(AsciiByte.Ltr_O       , Pft_fmt_itm_.Timezone_offset_4)       // timezone offset in seconds +0000
	.Add(AsciiByte.Ltr_P       , Pft_fmt_itm_.Timezone_offset_4_colon) // timezone offset in seconds with colon +00:00
