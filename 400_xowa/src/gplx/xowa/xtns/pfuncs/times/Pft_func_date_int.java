...
public class Pft_func_date_int extends Pf_func_base {
	...
	@Override public void Func_evaluate(BryWtr bfr, Xop_ctx ctx, Xot_invk caller, Xot_invk self, byte[] src) {
	    ...
	    switch (date_tid) {
	        case Date_tid_lcl: date = GfoDateNow.Get(); break;
	        case Date_tid_utc: date = GfoDateNow.Get().ToUtc(); break;
