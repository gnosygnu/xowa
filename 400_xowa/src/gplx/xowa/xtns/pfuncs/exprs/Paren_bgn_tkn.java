...
class Paren_bgn_tkn implements Expr_tkn, Func_tkn {
	...
	public byte[] Val_ary() {return val_ary;} private byte[] val_ary = BryUtl.NewU8(val_str);
	...
	public boolean Calc(Xop_ctx ctx, Pfunc_expr_shunter shunter, Val_stack val_stack) {throw ErrUtl.NewUnimplemented();}
