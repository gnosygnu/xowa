...
public class Articles_func_tst {
	...
	@Test public void Basic() {
		fxt.Test_parse("{{#related:A1 && A 1}}{{#related:B1 && B_1}}{{#related:C_1}}", StringUtl.ConcatLinesNlSkipLast    // C1 handles no caption; PAGE:de.v:W�rzburg; DATE:2014-08-06
