...
public class Entity__tst {
	...
	@Test public void GetGlobalSiteId() {
		fxt.Test_scrib_proc_str(lib, Scrib_lib_wikibase_entity.Invk__getGlobalSiteId, ObjectUtl.AryEmpty, "enwiki");
	}
	@Test public void GetLanguageCode() {
		fxt.Test_scrib_proc_str(lib, Scrib_lib_wikibase_entity.Invk__getLanguageCode, ObjectUtl.AryEmpty, "en");
	}
	@Test public void FormatPropertyValues() {
		...
		fxt.Test_scrib_proc_str(lib, Scrib_lib_wikibase_entity.Invk__formatPropertyValues, ObjectUtl.Ary("Q2", "P3")		, "P3_val");

		// lookup by name
		wdata_fxt.Init_pids_add("en", "P3_val", 3);
		fxt.Test_scrib_proc_str(lib, Scrib_lib_wikibase_entity.Invk__formatPropertyValues, ObjectUtl.Ary("Q2", "P3_val")	, "P3_val");
	}
	@Test public void FormatPropertyValues__not_found() {	// PURPOSE: should return "" not null; PAGE:fr.s:Auteur:Henri_Bergson; DATE:2014-08-13
		fxt.Test_scrib_proc_str(lib, Scrib_lib_wikibase_entity.Invk__formatPropertyValues, ObjectUtl.Ary("Q2", "P3"), "");
	}
}	
