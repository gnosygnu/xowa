...
public class Scrib_lib_ustring__find__tst {
	...
	@Test public void Plain() {
		fxt.Test__find("aabaab"        , "b"    ,  2, BoolUtl.Y, "3;3"); // bytes=1
		fxt.Test__find("¢¢b¢¢b"        , "b"    ,  2, BoolUtl.Y, "3;3"); // bytes=2
		fxt.Test__find("€€b€€b"        , "b"    ,  2, BoolUtl.Y, "3;3"); // bytes=3
		fxt.Test__find("𤭢𤭢b𤭢𤭢b"    , "b"    ,  2, BoolUtl.Y, "3;3"); // bytes=4
		fxt.Test__find("()()"          , "("    ,  2, BoolUtl.Y, "3;3"); // exact match; note that "(" is invalid regx
	...
	@Test public void Regx__simple() {
		fxt.Test__find("aabaab"        , "b"       ,  2, BoolUtl.N, "3;3"); // bytes=1
		fxt.Test__find("¢¢b¢¢b"        , "b"       ,  2, BoolUtl.N, "3;3"); // bytes=2
		fxt.Test__find("€€b€€b"        , "b"       ,  2, BoolUtl.N, "3;3"); // bytes=3
	...
	@Test public void Regx__groups() {
		fxt.Test__find("a bcd e"       , "(b(c)d)" ,  2, BoolUtl.N, "3;5;bcd;c"); // groups
		fxt.Test__find("a bcd e"       , "()(b)"   ,  2, BoolUtl.N, "3;3;3;b");   // groups; empty capture
	}
...
class Scrib_lib_ustring__find__fxt {
	...
	public Scrib_lib_ustring__find__fxt Dbg_y_() {dbg = BoolUtl.Y; return this;}
	public Scrib_lib_ustring__find__fxt Dbg_n_() {dbg = BoolUtl.N; return this;}
