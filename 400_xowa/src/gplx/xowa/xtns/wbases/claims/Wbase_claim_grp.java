...
public class Wbase_claim_grp {
	public Wbase_claim_grp(IntRef id_ref, Wbase_claim_base[] itms) {this.id_ref = id_ref; this.itms = itms;}
	public IntRef Id_ref() {return id_ref;} private final IntRef id_ref;
	public int Id() {return id_ref.Val();}
	public String Id_str() {if (id_str == null) id_str = "P" + IntUtl.ToStr(id_ref.Val()); return id_str;} private String id_str;
	...
	*/
	...
	public static List_adp Xto_list(Ordered_hash hash) {
		...
		for (int i = 0; i < len; ++i) {
			Wbase_claim_grp grp = (Wbase_claim_grp)hash.GetAt(i);
			int grp_len = grp.Len();
