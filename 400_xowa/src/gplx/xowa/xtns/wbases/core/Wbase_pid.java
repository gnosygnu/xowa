...
public class Wbase_pid {
	...
	public static int To_int_or_null(byte[] pid_ttl) {	// EX: "p123" -> "123"
		...
		return BryUtl.ToIntOr(pid_ttl, 1, len, Wbase_pid.Id_null);
	}
	public static byte[] Prepend_property_if_needed(byte[] bry) { // "p1" -> "Property:p1" or "P1" -> "Property:P1"
		...
		return	len > 1
			...
			?	BryUtl.Add(Wdata_wiki_mgr.Ns_property_name_bry, AsciiByte.ColonBry, bry)	// if ttl starts with "p#", prepend "Property:" to get "Property:p#"; NOTE: do not ucase P b/c it breaks a test; DATE:2014-02-18
			:	bry;
	}
	public static String Ucase_pid_as_str(String pid) {
		return StringUtl.HasAtBgn(pid, "p")
			? StringUtl.Upper(pid)	// convert "p123" to "P123"; note (a) Scrib.v2 calls as "P123"; (b) db stores as "p123"; (c) XO loads as "P123"; DATE:2016-12-03
			: pid;
	}
}
