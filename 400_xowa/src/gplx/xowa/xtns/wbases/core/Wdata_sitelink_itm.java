...
public class Wdata_sitelink_itm implements Wdata_lang_sortable {
	...
	public byte[] Lang() {return lang;} public void Lang_(byte[] v) {lang = v;} private byte[] lang = BryUtl.Empty;
	...
	@Override public String toString() {// TEST:
		return StringUtl.ConcatWith("|", StringUtl.NewU8(site), StringUtl.NewU8(name), StringUtl.ConcatWith(",", StringUtl.Ary(badges)));
	}
}
