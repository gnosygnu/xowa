...
public class Xop_wiki_setup_xnde implements Xox_xnde, Mwh_atr_itm_owner2 {
	...
	public void Xatr__set(Xowe_wiki wiki, byte[] src, Mwh_atr_itm xatr, byte xatr_id) {
		switch (xatr_id) {
			...
			case Xatr__wikis:			wikis_ary		= BrySplit.Split(xatr.Val_as_bry(), AsciiByte.PipeBry); break;
	...
	public Xop_root_tkn Xtn_root()	{throw ErrUtl.NewUnimplemented("xowa_wiki_setup.xtn_root should not be called");}
	public byte[] Xtn_html()		{throw ErrUtl.NewUnimplemented("xowa_wiki_setup.xtn_html should not be called");}
