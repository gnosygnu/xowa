...
public class Imap_link_owner_ {
	public static void Init(Imap_link_owner link_owner, Xoae_app app, Xowe_wiki wiki, byte[] src, Xop_tkn_itm tkn) {
		...
		try {
			...
			switch (tkn_tid) {
				case Xop_tkn_itm_.Tid_lnki: {
					...
					link_owner.Link_text_(bfr.ToBryAndClear());
					break;
				}
				case Xop_tkn_itm_.Tid_lnke: {
					...
					link_owner.Link_href_(bfr.ToBryAndClear());
		...
		finally {bfr.MkrRls();}	// release buffer in case of null error; PAGE:de.u:PPA/Raster/TK25/51/18/12/20; DATE:2015-02-02
	}
