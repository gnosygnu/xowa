...
public class References_nde_rare_tst {
	...
	@Test public void Backlabel_out_of_range() {	// PURPOSE: handle more backlabels than expected; PAGE:en.w:List_of_Russula_species; DATE:2014-06-07
		...
		cfg.Backlabels_(BryUtl.Ary("a"));
		fxt.Wiki().Msg_mgr().Get_or_make(Ref_html_wtr_cfg.Msg_backlabels_err).Atrs_set(BryUtl.NewA7("Ran out of custom link labels for group ~{0}."), true, false);
		fxt.Test_parse_page_wiki_str(StringUtl.ConcatLinesNlSkipLast
