...
public class Xow_domain_uid_ {
	...
	public static int To_int(Xow_domain domain) {
		...
		switch (domain.Domain_tid()) {
			...
			case Xow_domain_type_.Tid_wmforg:				return Tid_wmforg;
	...
	public static Xow_domain To_domain(int tid) {
		switch (tid) {
			...
			case Tid_wmforg:								return Xow_domain.new_(Xow_domain_.Domain_bry_wmforg, Xow_domain_type_.Tid_wmforg, Xol_lang_itm_.Key__unknown);
