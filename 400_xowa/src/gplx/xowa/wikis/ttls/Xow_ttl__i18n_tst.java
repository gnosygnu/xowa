...
public class Xow_ttl__i18n_tst {
	...
	@Test public void Bidi() {	// PURPOSE: handle bidirectional characters; DATE:2015-07-28; DATE:2015-08-24
		fxt.Init_ttl("A" + StringUtl.NewU8(BryUtl.NewByInts(0xE2, 0x80, 0x8E)) + "B").Expd_page_txt("AB").Test();
		fxt.Init_ttl("A" + StringUtl.NewU8(BryUtl.NewByInts(0xE2, 0x80, 0x8F)) + "B").Expd_page_txt("AB").Test();
		fxt.Init_ttl("A" + StringUtl.NewU8(BryUtl.NewByInts(0xE2, 0x80, 0xAA)) + "B").Expd_page_txt("AB").Test();
		fxt.Init_ttl("A" + StringUtl.NewU8(BryUtl.NewByInts(0xE2, 0x80, 0xAB)) + "B").Expd_page_txt("AB").Test();
		fxt.Init_ttl("A" + StringUtl.NewU8(BryUtl.NewByInts(0xE2, 0x80, 0xAC)) + "B").Expd_page_txt("AB").Test();
		fxt.Init_ttl("A" + StringUtl.NewU8(BryUtl.NewByInts(0xE2, 0x80, 0xAD)) + "B").Expd_page_txt("AB").Test();
		fxt.Init_ttl("A" + StringUtl.NewU8(BryUtl.NewByInts(0xE2, 0x80, 0xAE)) + "B").Expd_page_txt("AB").Test();
	}
