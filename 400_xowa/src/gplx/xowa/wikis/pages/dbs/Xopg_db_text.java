...
public class Xopg_db_text {
	public byte[]		Text_bry()	{return text_bry;}	private byte[] text_bry = BryUtl.Empty;	// NOTE: if null, will cause NullPointer exception on Special pages like Special:XowaDownloadCentral; DATE:2016-07-05
