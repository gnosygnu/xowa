...
public class Xopg_wtxt_data {
	...
	public Xoa_ttl					Ctgs__get_at(int i) {return (Xoa_ttl)ctg_hash.GetAt(i);}
	public Xoa_ttl[]				Ctgs__to_ary()		{return ctg_hash == null ? new Xoa_ttl[0] : (Xoa_ttl[])ctg_hash.ToAry(Xoa_ttl.class);}
	public void Ctgs__add(Xoa_ttl ttl) {
		if (ctg_hash == null) ctg_hash = Ordered_hash_.New_bry();
		ctg_hash.AddIfDupeUse1st(ttl.Full_db(), ttl);
	}
	public void Clear() {
