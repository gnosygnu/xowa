...
public class Xow_domain_ {
	...
	, Domain_bry_home							= Bry_.new_ascii_("home")
	, Domain_bry_mediawiki						= Bry_.new_ascii_("www.mediawiki.org")
	, Domain_bry_meta							= Bry_.new_ascii_("meta.wikimedia.org")
	, Domain_bry_incubator						= Bry_.new_ascii_("incubator.wikimedia.org")
	...
	, Tid_int_wikidata  = 14, Tid_int_mediawiki  = 15, Tid_int_wikimediafoundation = 16, Tid_int_wikimedia = 17
	;
	public static final String 
	  Tid_str_home = "home"
	;
	...
	, Tid_bry_species = Bry_.new_ascii_("species"), Tid_bry_mediawiki = Bry_.new_ascii_("mediawiki"), Tid_bry_wikimedia = Bry_.new_ascii_("wikimedia")
	;
	...
	, Tid_bry_wikidata, Tid_bry_mediawiki, Tid_bry_wikimediafoundation, Tid_bry_wikimedia
	};
	public static final byte[] Seg_bry_org = Bry_.new_ascii_("org"), Seg_bry_www = Bry_.new_utf8_("www");
	...
	.Add_bry_int(Tid_bry_wikimedia				, Tid_int_wikimedia)
		...
		*/
		...
		if (dot_0 == Bry_.NotFound) {	// 0 dots; check for "home"
			return Bry_.Eq(raw, Tid_bry_home)
				? Xow_domain_tid_.To_domain(Xow_domain_tid_.Tid_xowa)
				: new_other(raw);
		}
		...
		switch (seg_1_tid) {
			...
			case Tid_int_wikimedia:																				// ~{type}.wikimedia.org;
				Object seg_0_obj = hash_tid_by_bry.Get_by_mid(raw, 0, dot_0);
				if (seg_0_obj == null) {
					Xol_lang_itm wikimedia_lang = Xol_lang_itm_.Get_by_key_or_null(raw, 0, dot_0);
					return wikimedia_lang == null ? new_other(raw) : Xow_domain.new_(raw, Tid_int_wikimedia, wikimedia_lang.Key());
				}
