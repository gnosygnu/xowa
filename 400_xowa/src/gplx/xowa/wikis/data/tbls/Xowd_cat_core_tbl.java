...
public class Xowd_cat_core_tbl implements Db_tbl {
	...
	public Xowd_cat_core_tbl(Db_conn conn, boolean schema_is_1) {
		...
		fld_id				= flds.AddIntPkey("cat_id");
		fld_pages			= flds.AddInt("cat_pages");
		fld_subcats			= flds.AddInt("cat_subcats");
		fld_files			= flds.AddInt("cat_files");
		fld_hidden			= flds.AddByte("cat_hidden");
		fld_link_db_id		= flds.AddInt(fld_link_db_id_name);
