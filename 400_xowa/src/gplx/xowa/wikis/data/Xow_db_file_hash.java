...
class Xow_db_file_hash {
	...
	public Ordered_hash Get_by_tid_or_null(byte tid) {return (Ordered_hash)hash.GetByOrNull(tid);}
	public void Add_or_new(Xow_db_file file) {
		byte tid = file.Tid();
		Ordered_hash tids = (Ordered_hash)hash.GetByOrNull(tid);
		if (tids == null) {
