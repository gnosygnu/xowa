...
public class Xowd_hive_mgr_tst {
	...
	@Test public void Create() {
		fxt.Create("A", "A|A data\n")
			.Tst_reg(StringUtl.ConcatLinesNl("0|A|A|1"))
			.Tst_fil(0, StringUtl.Concat("!!!!*|\n", "A|A data\n"))
			;
	}
	@Test public void Create_2() {
		fxt	.Create("A", "A|1\n")
			.Create("B", "B|12\n")
			.Tst_reg(StringUtl.ConcatLinesNl("0|A|B|2"))
			.Tst_fil(0, StringUtl.Concat("!!!!%|!!!!&|\n", "A|1\n", "B|12\n"))
			;
	}
	@Test public void Create_3() {
		fxt	.Create("A", "A|1\n")
			.Create("B", "B|12\n")
			.Create("C", "C|123\n")
			.Tst_reg(StringUtl.ConcatLinesNl("0|A|C|3"))
			.Tst_fil(0, StringUtl.Concat("!!!!%|!!!!&|!!!!'|\n", "A|1\n", "B|12\n", "C|123\n"))
			;
	}
...
class Xowd_hive_mgr_fxt {
	...
	public Xowd_hive_mgr_fxt Tst_reg(String expd) {
		...
		GfoTstr.EqLines(expd, Io_mgr.Instance.LoadFilStr(file_orig));
		return this;
	}
	...
	public Xowd_hive_mgr_fxt Update(String key, String data) {
		mgr.Update(wiki.Ns_mgr().Ns_main(), BryUtl.NewA7(key), null, BryUtl.NewA7(data), 0, AsciiByte.Pipe, true, true);
		return this;
	}
	public Xowd_hive_mgr_fxt Create(String key, String data) {
		mgr.Create(wiki.Ns_mgr().Ns_main(), BryUtl.NewA7(key), BryUtl.NewA7(data), null);
		return this;
	}
	public Xowd_hive_mgr_fxt Create_and_sort(String key, String data) {
		mgr.Create(wiki.Ns_mgr().Ns_main(), BryUtl.NewA7(key), BryUtl.NewA7(data), new Bry_comparer_bgn_eos(0));
		return this;
	}
