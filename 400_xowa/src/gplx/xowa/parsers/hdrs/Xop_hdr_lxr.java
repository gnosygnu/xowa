...
public class Xop_hdr_lxr implements Xop_lxr {
	...
	public void Init_by_wiki(Xowe_wiki wiki, Btrie_fast_mgr core_trie) {core_trie.Add(Hook_bgn, this);} static final byte[] Hook_bgn = new byte[] {AsciiByte.Nl, AsciiByte.Eq};
	...
	public static final byte Hook = AsciiByte.Eq;
}
