...
public class Xop_colon_lxr implements Xop_lxr {
	...
	public void Init_by_wiki(Xowe_wiki wiki, Btrie_fast_mgr core_trie) {core_trie.Add(AsciiByte.Colon, this);}
