...
public class Xop_list_tkn extends Xop_tkn_itm_base {
	...
	public int[] List_path() {return path;} public Xop_list_tkn List_path_(int... v) {path = v; return this;} private int[] path = IntAryUtl.Empty;
	public int List_path_idx() {return path[path.length - 1];}
	public boolean List_sub_first() {return List_path_idx() == 0;}
	public byte List_sub_last() {return list_sub_last;} public Xop_list_tkn List_sub_last_(byte v) {list_sub_last = v; return this;} private byte list_sub_last = BoolUtl.NullByte;
	public static Xop_list_tkn bgn_(int bgn, int end, byte list_itmTyp, int symLen) {return new Xop_list_tkn(bgn, end, BoolUtl.YByte, list_itmTyp);}
	public static Xop_list_tkn end_(int pos, byte list_itmTyp) {return new Xop_list_tkn(pos, pos, BoolUtl.NByte, list_itmTyp);}
