...
public class Xop_list_tkn_ {
	...
	public static final byte[] Byt_li = BryUtl.NewA7(Str_li), Byt_ol = BryUtl.NewA7(Str_ol), Byt_ul = BryUtl.NewA7(Str_ul)
								, Byt_dl = BryUtl.NewA7(Str_dl), Byt_dt = BryUtl.NewA7(Str_dt), Byt_dd = BryUtl.NewA7(Str_dd);
