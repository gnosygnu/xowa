...
public class Xop_nl_tab_lxr implements Xop_lxr {
	...
	public void Init_by_wiki(Xowe_wiki wiki, Btrie_fast_mgr core_trie) {core_trie.Add(Hook_nl_tab, this);} private static final byte[] Hook_nl_tab = new byte[] {AsciiByte.Nl, AsciiByte.Tab};
