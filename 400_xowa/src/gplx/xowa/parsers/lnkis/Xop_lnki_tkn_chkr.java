...
public class Xop_lnki_tkn_chkr extends Xop_tkn_chkr_base {
	...
	public int Ns_id() {return nsId;} public Xop_lnki_tkn_chkr Ns_id_(int v) {nsId = v; return this;} private int nsId = IntUtl.MinValue;
	public byte ImgType() {return imgType;} public Xop_lnki_tkn_chkr ImgType_(byte v) {imgType = v; return this;} private byte imgType = ByteUtl.MaxValue127;
	public int Width() {return width;} public Xop_lnki_tkn_chkr Width_(int v) {width = v; return this;} private int width = IntUtl.MinValue;
	public int Height() {return height;} public Xop_lnki_tkn_chkr Height_(int v) {height = v; return this;} private int height = IntUtl.MinValue;
	public int HAlign() {return hAlign;} public Xop_lnki_tkn_chkr HAlign_(int v) {hAlign = v; return this;} private int hAlign = ByteUtl.MaxValue127;
	public byte VAlign() {return vAlign;} public Xop_lnki_tkn_chkr VAlign_(byte v) {vAlign = v; return this;} private byte vAlign = ByteUtl.MaxValue127;
	public byte Border() {return border;} public Xop_lnki_tkn_chkr Border_(byte v) {border = v; return this;} private byte border = BoolUtl.NullByte;
	...
	public int Tail_bgn() {return tail_bgn;} public Xop_lnki_tkn_chkr Tail_bgn_(int v) {tail_bgn = v; return this;} private int tail_bgn = StringUtl.PosNeg1;
	public int Tail_end() {return tail_end;} public Xop_lnki_tkn_chkr Tail_end_(int v) {tail_end = v; return this;} private int tail_end = StringUtl.PosNeg1;
	...
	@Override public int Chk_hook(Tst_mgr mgr, String path, Object actl_obj, int err) {
		...
		err += mgr.Tst_val(nsId == IntUtl.MinValue, path, "nsId", nsId, actl.Ns_id());
		err += mgr.Tst_val(imgType == ByteUtl.MaxValue127, path, "imgType", imgType, actl.Lnki_type());
		err += mgr.Tst_val(width == IntUtl.MinValue, path, "width", width, actl.W());
		err += mgr.Tst_val(height == IntUtl.MinValue, path, "height", height, actl.H());
		err += mgr.Tst_val(hAlign == ByteUtl.MaxValue127, path, "halign", hAlign, actl.Align_h());
		err += mgr.Tst_val(vAlign == ByteUtl.MaxValue127, path, "valign", vAlign, actl.Align_v());
		err += mgr.Tst_val(border == BoolUtl.NullByte, path, "border", border, actl.Border());
		err += mgr.Tst_val(tail_bgn == StringUtl.PosNeg1, path, "tail_bgn", tail_bgn, actl.Tail_bgn());
		err += mgr.Tst_val(tail_end == StringUtl.PosNeg1, path, "tail_end", tail_end, actl.Tail_end());
