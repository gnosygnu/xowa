...
public class Xop_lnki_wkr__link__basic__tst {
	...
	@Test public void Link() {
		...
		( "[[File:A.png|12x10px|link=File:B.png|c]]", StringUtl.ConcatLinesNlSkipLast
	...
	@Test public void Link_blank() {
		fxt.Test_parse_page_wiki_str
		( "[[File:A.png|12x10px|link=|c]]", StringUtl.ConcatLinesNlSkipLast
	...
	@Test public void Link_external() {
		fxt.Test_parse_page_wiki_str
		( "[[File:A.png|12x10px|link=http://www.b.org|c]]", StringUtl.ConcatLinesNlSkipLast
	...
	@Test public void Link_file_system() {
		fxt.Test_parse_page_wiki_str
		( "[[File:A.png|12x10px|link=file:///C/B.png|c]]", StringUtl.ConcatLinesNlSkipLast
	...
	@Test public void Link_external_double_http() {// PURPOSE.fix: link=http://a.org?b=http://c.org breaks lnki; DATE:2013-02-03
		fxt.Test_parse_page_wiki_str
		( "[[File:A.png|12x10px|link=//a.org?b=http://c.org]]", StringUtl.ConcatLinesNlSkipLast
