...
public class Xop_curly_bgn_lxr implements Xop_lxr {
	...
	public void Init_by_wiki(Xowe_wiki wiki, Btrie_fast_mgr core_trie) {core_trie.Add(Hook, this);} public static final byte[] Hook = new byte[] {AsciiByte.CurlyBgn, AsciiByte.CurlyBgn};
