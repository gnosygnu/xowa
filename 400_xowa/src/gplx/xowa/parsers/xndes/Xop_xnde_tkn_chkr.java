...
public class Xop_xnde_tkn_chkr extends Xop_tkn_chkr_base {
	...
	public Xop_xnde_tkn_chkr Name_rng_(int bgn, int end) {name_bgn = bgn; name_end = end; return this;} private int name_bgn = StringUtl.PosNeg1; int name_end = StringUtl.PosNeg1;
	public Xop_xnde_tkn_chkr Atrs_rng_(int bgn, int end) {atrs_bgn = bgn; atrs_end = end; return this;} private int atrs_bgn = StringUtl.PosNeg1; int atrs_end = StringUtl.PosNeg1;
	@Override public int Chk_hook(Tst_mgr mgr, String path, Object actl_obj, int err) {
		...
		err += mgr.Tst_val(name_bgn == StringUtl.PosNeg1, path, "name_bgn", name_bgn, actl.Name_bgn());
		err += mgr.Tst_val(name_end == StringUtl.PosNeg1, path, "name_end", name_end, actl.Name_end());
		err += mgr.Tst_val(atrs_bgn == StringUtl.PosNeg1, path, "atrs_bgn", atrs_bgn, actl.Atrs_bgn());
		err += mgr.Tst_val(atrs_end == StringUtl.PosNeg1, path, "atrs_end", atrs_end, actl.Atrs_end());
		if (xnde_data != null)
