...
public class Xop_tblw_tb_tkn_chkr extends Xop_tkn_chkr_base {
	...
	public int Caption_count() {return caption_count;} public Xop_tblw_tb_tkn_chkr Caption_count_(int v) {caption_count = v; return this;} private int caption_count = IntUtl.Neg1;
	...
	@Override public int Chk_hook(Tst_mgr mgr, String path, Object actl_obj, int err) {
		...
		err += mgr.Tst_val(caption_count == IntUtl.Neg1, path, "caption_count", caption_count, actl.Caption_count());
