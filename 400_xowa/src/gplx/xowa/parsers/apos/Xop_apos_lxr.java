...
public class Xop_apos_lxr implements Xop_lxr {
	...
	public void Init_by_wiki(Xowe_wiki wiki, Btrie_fast_mgr core_trie) {core_trie.Add(Apos_ary, this);} private static final byte[] Apos_ary = new byte[] {AsciiByte.Apos, AsciiByte.Apos};
