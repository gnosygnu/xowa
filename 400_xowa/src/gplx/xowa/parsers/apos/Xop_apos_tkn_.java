...
public class Xop_apos_tkn_ {
	...
	= new byte[][] 
	{ BryUtl.NewA7("nil")
	, BryUtl.NewA7("i+"), BryUtl.NewA7("i-"), BryUtl.NewA7("b+"), BryUtl.NewA7("b-")
	, BryUtl.NewA7("bi+"), BryUtl.NewA7("ib+"), BryUtl.NewA7("ib-"), BryUtl.NewA7("bi-")
	, BryUtl.NewA7("bi-b+"), BryUtl.NewA7("ib-i+"), BryUtl.NewA7("b-i+"), BryUtl.NewA7("i-b+")
	};
	public static String Cmd_str(int id) {return StringUtl.NewU8(Cmds[id]);}
