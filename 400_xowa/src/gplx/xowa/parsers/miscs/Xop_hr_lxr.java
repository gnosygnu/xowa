...
public class Xop_hr_lxr implements Xop_lxr {
	...
	public void Init_by_wiki(Xowe_wiki wiki, Btrie_fast_mgr parse_trie) {parse_trie.Add(Hook_ary, this);} static final byte[] Hook_ary = new byte[] {AsciiByte.Nl, AsciiByte.Dash, AsciiByte.Dash, AsciiByte.Dash, AsciiByte.Dash};
	...
	public int Make_tkn(Xop_ctx ctx, Xop_tkn_mkr tkn_mkr, Xop_root_tkn root, byte[] src, int src_len, int bgn_pos, int cur_pos) {
		...
		return cur_pos;
	}	private static final byte Hook_byt = AsciiByte.Dash;
