...
class List_adp_noop implements List_adp {
	...
	public Object GetAt(int i) {return null;}
	...
	public int IdxOf(Object o) {return List_adp_.NotFound;}
	public void MoveTo(int elemPos, int newPos) {}
	public void ResizeBounds(int i) {}
	public Object ToAry(Class<?> memberType) {return ObjectUtl.AryEmpty;}
	public Object ToAryAndClear(Class<?> memberType) {return ObjectUtl.AryEmpty;}
	public String[] ToStrAry() {return StringUtl.AryEmpty;}
	public String[] ToStrAryAndClear() {return ToStrAry();}
	public String ToStr() {return "";}
	public Object[] ToObjAry() {return ObjectUtl.AryEmpty;}
