...
class Hash_adp_bry_fxt {
	...
	public Hash_adp_bry_fxt Add(String key) {byte[] key_bry = BryUtl.NewU8(key); hash.Add(key_bry, key_bry); return this;}
	public Hash_adp_bry_fxt Count_tst(int expd) {GfoTstr.EqObj(expd, hash.Len()); return this;}
	...
	public Hash_adp_bry_fxt Get_bry_tst(String key, String expd) {
		...
		GfoTstr.EqObj(expd, StringUtl.NewU8(actl_bry));
		return this;
	}
