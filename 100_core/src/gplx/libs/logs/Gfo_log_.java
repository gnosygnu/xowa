...
public class Gfo_log_ {
	...
	public static Io_url New_url(Io_url dir) {
		return dir.GenSubFil(GfoDateNow.Get().ToUtc().ToStrFmt(Gfo_log_.File__fmt) + Gfo_log_.File__ext);
	}
	public static Gfo_log New_file(Io_url dir) {
		Io_url url = dir.GenSubFil(GfoDateNow.Get().ToStrFmt(File__fmt) + File__ext);
