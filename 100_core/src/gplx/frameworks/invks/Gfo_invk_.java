...
public class Gfo_invk_ {
	...
	public static final StringVal
		Rv_unhandled    = StringVal.New("Unhandled")
	, Rv_handled    = StringVal.New("Handled")
	, Rv_host        = StringVal.New("Host")
	, Rv_cancel        = StringVal.New("Cancel")
	, Rv_error        = StringVal.New("Error")
	, ArgNone       = StringVal.New("")
	;
	...
	public static Object Invk_by_msg(Gfo_invk invk, String k, GfoMsg m)    {
		...
		if (rv == Gfo_invk_.Rv_unhandled) throw ErrUtl.NewArgs("invkable did not handle message", "key", k);
		return rv;
	}
}
