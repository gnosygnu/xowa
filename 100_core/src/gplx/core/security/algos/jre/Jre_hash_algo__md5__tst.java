...
public class Jre_hash_algo__md5__tst {    // REF: https://www.cosic.esat.kuleuven.be/nessie/testvectors/hash/md5/Md5-128.unverified.test-vectors
	...
	//@Test
	public void Num__x_8()                    {fxt.Test__hash("57edf4a22be3c955ac49da2e2107b67a", StringUtl.Repeat("1234567890", 8));}
	//@Test
	public void A__x_1million()                {fxt.Test__hash("7707d6ae4e027c70eea2a935c2296f21", StringUtl.Repeat("a", 1000000));}
}
