...
public abstract class Criteria_bool_base implements Criteria {
	public void Ctor(String op_literal, Criteria lhs, Criteria rhs) {this.op_literal = op_literal; this.lhs = lhs; this.rhs = rhs;}
	...
	public String ToStr() {return StringUtl.Concat(lhs.ToStr(), " ", this.op_literal, " ", rhs.ToStr());}
...
class Criteria_const implements Criteria {
	...
	public void                Val_as_obj_(Object v) {throw ErrUtl.NewUnimplemented();}
	public String ToStr() {return StringUtl.Concat(" IS ", BoolUtl.ToStrLower(val));}
}
