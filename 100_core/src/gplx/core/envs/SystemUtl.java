...
public class SystemUtl {
	...
	public static GfoTimeSpan TicksFrom(long bgn) {return GfoTimeSpanUtl.NewFracs(Ticks() - bgn);}
	...
	public static String Env__machine_name() {
		String rv = "";
		rv = Env__get(Env_key__computername);    if (StringUtl.IsNotNullOrEmpty(rv)) return rv;
		rv = Env__get(Env_key__hostname);        if (StringUtl.IsNotNullOrEmpty(rv)) return rv;
