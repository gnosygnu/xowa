...
public class GfoNde_ {
	...
	public static GfoNde root_(GfoNde... subs)                                {return new GfoNde(GfoNde_.Type_Root, "RootName", GfoFldList_.Null, ObjectUtl.AryEmpty, GfoFldList_.Null, subs);}
	public static GfoNde tbl_(String name, GfoFldList flds, GfoNde... rows)    {return new GfoNde(GfoNde_.Type_Node, name, flds, ObjectUtl.AryEmpty, flds, rows);}
	...
	public static final int Type_Leaf = 1, Type_Node = 2, Type_Root = 3;
}
