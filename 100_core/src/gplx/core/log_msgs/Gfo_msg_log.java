...
public class Gfo_msg_log {
	...
	public Gfo_msg_log Add_str_warn_fmt_none(String grp, String itm, String fmt)                                        {return Add_str(Gfo_msg_itm_.Cmd_warn, grp, itm, fmt , BryUtl.Empty, -1, -1, null);}
	...
	public Gfo_msg_log Add_str_warn_fmt_many(String grp, String itm, String fmt, Object... vals)                    {return Add_str(Gfo_msg_itm_.Cmd_warn, grp, itm, fmt , BryUtl.Empty, -1, -1, vals);}
