...
public abstract class DataWtr_base implements SrlMgr {
	...
	public GfoDate SrlDateOr(String key, GfoDate or) {WriteData(key, or.ToStrGplx()); return or;}
	public GfoDecimal SrlDecimalOr(String key, GfoDecimal or) {WriteData(key, or.Under()); return or;}
