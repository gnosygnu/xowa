...
public class RegxPatn_cls_like {
	...
	@Override public String toString() {return StringUtl.Format("LIKE {0} ESCAPE {1} -> {2}", raw, escape, compiled);}

	String compiled;
	public RegxPatn_cls_like(String raw, String compiled, char escape) {
		this.raw = raw;
