...
public class RegxPatn_cls_ioMatch_ {
	...
	public static RegxPatn_cls_ioMatch cast(Object obj) {try {return (RegxPatn_cls_ioMatch)obj;} catch(Exception exc) {throw ErrUtl.NewCast(exc, RegxPatn_cls_ioMatch.class, obj);}}
