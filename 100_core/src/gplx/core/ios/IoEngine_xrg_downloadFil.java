...
public class IoEngine_xrg_downloadFil {
	...
	public String Rslt_err_str() {
		return rslt_err == null ? "none" : ErrUtl.ToStrFull(rslt_err);
	}
	...
	public BryFmtr Prog_fmtr() {return prog_fmtr;} private final BryFmtr prog_fmtr = BryFmtr.New("~{download_header}: ~{download_read} of ~{download_length} kb;", "download_header", "download_url", "download_read", "download_length");
	...
	public GfoDate Src_last_modified() {return src_last_modified;} public IoEngine_xrg_downloadFil Src_last_modified_(GfoDate v) {src_last_modified = v; return this;} private GfoDate src_last_modified;
