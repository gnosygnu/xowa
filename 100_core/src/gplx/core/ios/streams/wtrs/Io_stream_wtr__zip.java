...
public class Io_stream_wtr__zip extends Io_stream_wtr__base {
	...
	public void Trg_bfr_(BryWtr v) {trg_bfr = v;} private BryWtr trg_bfr; private java.io.ByteArrayOutputStream mem_stream;
	...
	public void Flush() {// fixed as of DATE:2014-04-15
		...
		catch (Exception e) {throw ErrUtl.NewArgs(e, "flush failed", "url", url.Raw());}
	}
	public void Rls() {
		try {
