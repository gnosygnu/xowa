...
class Io_stream_rdr__fxt {
	...
	public void Clear() {
		expd_bytes_read = IntUtl.MinValue;
	}
	public Io_stream_rdr__fxt Expd_bytes_read(int v) {expd_bytes_read = v; return this;} private int expd_bytes_read = IntUtl.MinValue;
	public Io_stream_rdr__fxt Init_stream(String v) {
		byte[] stream_bry = BryUtl.NewA7(v);
	...
	public Io_stream_rdr__fxt Test_read(int bgn, int len, String expd_str) {
		...
		GfoTstr.EqObj(expd_bytes_read, actl_bytes_read, "bytes_read");
		GfoTstr.EqObj(expd_str, StringUtl.NewU8(bfr, bgn, bgn + actl_bytes_read), "str");
		return this;
	}
	public void Rls() {
