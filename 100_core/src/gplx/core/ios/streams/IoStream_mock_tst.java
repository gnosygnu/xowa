...
class IoStream_mock_fxt {
	...
	public IoStream_mock_fxt Init_src_str_(String v) {rdr.Data_bry_(BryUtl.NewA7(v)); return this;}
	...
	public IoStream_mock_fxt Test_read(String expd) {
		...
		GfoTstr.EqObj(expd, StringUtl.NewA7(trg_bry, trg_bgn, trg_bgn + bytes_read));
		trg_bgn += bytes_read;
		return this;
	}   int trg_bgn;
}
