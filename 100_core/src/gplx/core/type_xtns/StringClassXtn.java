...
public class StringClassXtn extends ClassXtn_base implements ClassXtn {
	...
	@Override public String XtoUi(Object obj, String fmt)        {return StringUtl.CastOrNull(obj);}
	public boolean Eq(Object lhs, Object rhs) {try {return StringUtl.Eq(StringUtl.Cast(lhs), StringUtl.Cast(rhs));} catch (Exception e) {return false;}}
