...
public class DoubleClassXtn extends ClassXtn_base implements ClassXtn {
	...
	public boolean Eq(Object lhs, Object rhs) {try {return DoubleUtl.Cast(lhs) == DoubleUtl.Cast(rhs);} catch (Exception e) {return false;}}
	@Override public Object ParseOrNull(String raw)                {return DoubleUtl.Parse(raw);}
