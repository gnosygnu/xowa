...
public class IntClassXtn extends ClassXtn_base implements ClassXtn {
	...
	@Override public Object ParseOrNull(String raw)                {return raw == null ? (Object)null : IntUtl.Parse(raw);}
	public boolean Eq(Object lhs, Object rhs) {try {return IntUtl.Cast(lhs) == IntUtl.Cast(rhs);} catch (Exception e) {return false;}}
	@Override public Object XtoDb(Object obj)                    {return IntUtl.Cast(obj);}    // necessary for enums
