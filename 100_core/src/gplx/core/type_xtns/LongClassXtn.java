...
public class LongClassXtn extends ClassXtn_base implements ClassXtn {
	...
	public boolean Eq(Object lhs, Object rhs) {try {return LongUtl.Cast(lhs) == LongUtl.Cast(rhs);} catch (Exception e) {return false;}}
	@Override public Object ParseOrNull(String raw)                {return raw == null ? (Object)null : LongUtl.Parse(raw);}
	@Override public Object XtoDb(Object obj)                    {return LongUtl.Cast(obj);}                        // necessary for enums
