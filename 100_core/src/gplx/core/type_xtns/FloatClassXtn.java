...
public class FloatClassXtn extends ClassXtn_base implements ClassXtn {
	...
	public boolean Eq(Object lhs, Object rhs) {try {return FloatUtl.Cast(lhs) == FloatUtl.Cast(rhs);} catch (Exception e) {return false;}}
	@Override public Object ParseOrNull(String raw)                {return FloatUtl.Parse(raw);}
