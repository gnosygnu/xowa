...
public class XmlNde {
	...
	public String Xml_outer() {
		...
		catch (TransformerException e) {throw ErrUtl.NewArgs(e, "failed to get xml string");}
	...
	public XmlNde(Node xnde) {this.xnde = xnde;} Node xnde;
	static Transformer transformer_() {
		TransformerFactory transformerfactory = TransformerFactory.newInstance();
		Transformer transformer = null;
		try {transformer = transformerfactory.newTransformer();}
		catch (TransformerConfigurationException e) {throw ErrUtl.NewArgs(e, "failed to get create transformer");}
