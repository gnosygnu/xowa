...
public class StringTableCol {
	...
	public String PadCell(String cell) {
		...
		else									throw Err_.unhandled(halign.Val());
	}
	...
	public static StringTableCol cast_(Object obj) {try {return (StringTableCol)obj;} catch(Exception exc) {throw Err_.type_mismatch_exc_(exc, StringTableCol.class, obj);}}
}
